...
app.post('/webhook/', function (req, res) {
    ...
    for (let i = 0; i < messaging_events.length; i++) {
        ...
        if (event.message && event.message.text) {
            ...
            let messageData = { text:"Text received, echo: " + text.substring(0, 200) };
		    request({
		        url: 'https://graph.facebook.com/v2.6/me/messages',
		        qs: {access_token:'EAARMCn5MhLkBAJyYRjlxgu6I3WEkpSKgZBBkeNJZCXZCEiKPOZAeU3DruWZBCDKlhDxNh0Rl5RDZCBIvLUx2OVU9SiM7ftbRSMuBaf1tohvEaRiVRBp3FWu0IrgKKdQYOZBPUOoZBefjuflUEM4vxrXR2px0Y7ZBL2OZB2emlawnRGfwZDZD'},
		        method: 'POST',
		        json: {
		            recipient: {id:sender},
		            message: messageData,
